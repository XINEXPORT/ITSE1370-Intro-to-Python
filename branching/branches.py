...
################ 
# When the input variable number_of_files is:

# less than 35, output 'Medium file cabinet'.
# between 35 inclusive and 143 inclusive, output 'Large file cabinet'.
# greater than 143, output 'Need multiple cabinets'.

number_of_files = int(input())

if number_of_files < 35:
    print('Medium file cabinet')
elif 35 <= number_of_files <= 143:
    print('Large file cabinet')
else:
    print('Need multiple cabinets')

################ 
# When the input variable product_count is:

# greater than 15, output 'Must split order'.
# between 5 inclusive and 15 inclusive, output 'Mid-sized box'.
...
if product_count > 15:
    print('Must split order')
elif 5 <= product_count <= 15:
    print('Mid-sized box')
elif 1 <= product_count <= 4:
    print('Small box')
